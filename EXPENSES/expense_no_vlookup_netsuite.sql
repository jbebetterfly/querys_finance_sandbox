...
gastos_base.accounting_department_id,
gastos_base.accounting_department_name,
gastos_base.accounting_country_id,
gastos_base.accounting_country_name,
relacion_cecos.management_department,
classification_department.department_classification,
gastos_base.product_id,
gastos_base.product_name,
...
gastos_base.segment_name as holding_segment,
